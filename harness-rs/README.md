...
spacetime call orchestrator-harness goal_add \
  '{"goal_key":"orchestrator.collect_more_sessions","parent_goal_key":null,"title":"Collect more session captures","detail":"Gather additional live captures for validation","status":"pending","priority":15,"depends_on_goal_key":null,"success_fact_key":"agent_c.more_sessions_collected","metadata_json":"{}","completion_report":null,"tick":null,"scope_note":null,"clear_scope_note":false,"instruction_text":null,"stuck_guidance_text":null,"blocked_by":null}'
...
./harness goal-tree --json
./harness goal-tree orchestrator.collect_more_sessions --json
